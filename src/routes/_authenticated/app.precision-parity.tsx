...
export const Route = createFileRoute("/_authenticated/app/precision-parity")({
  head: () => ({
    meta: [
      { title: "Precision Parity — multi-engine digit parity intelligence" },
      {
        name: "description",
        content:
          "Multi-engine parity analysis across Deriv synthetic markets: confluence, hazard, calibration and entry criteria in one live console.",
      },
      { property: "og:title", content: "Precision Parity — multi-engine digit parity intelligence" },
      {
